      ...
      <div className="relative w-full max-w-xl bg-white rounded-3xl shadow-2xl border border-stone-200 overflow-hidden">
        ...
        <div className="p-6 border-b border-stone-200 bg-stone-50 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-base font-bold font-serif text-stone-900">Partner with DineTable</h2>
        ...
        {submitted ? (
          <div className="p-10 text-center space-y-4">
            ...
            <p className="text-xs text-stone-600 max-w-sm mx-auto">
              Thank you for partnering with DineTable. Our restaurant onboarding manager will reach out within 24 hours to set up your floor plan.
            </p>
          </div>
        ) : (
